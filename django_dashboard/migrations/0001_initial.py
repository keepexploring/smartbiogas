# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-01-11 11:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plant_status', enumfields.fields.EnumField(enum=django_dashboard.enums.BiogasPlant.PlantStatus, max_length=1, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_address2', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            name='Dashboard',
            fields=[
                ('company', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='django_dashboard.Company')),
        ...
        migrations.AddField(
            model_name='biogasplant',
            name='constructing_technician',
            field=models.ManyToManyField(blank=True, to='django_dashboard.TechnicianDetail'),
        ),
    ]
