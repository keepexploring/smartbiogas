# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-01-10 13:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_location', models.CharField(blank=True, max_length=400, null=True)),
                ('postcode', models.CharField(blank=True, max_length=20, null=True)),
                ('type_biogas', models.CharField(blank=True, choices=[('TUBULAR', 'tubular'), ('FIXED_DOME', 'fixed_dome')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            name='Dashboard',
            fields=[
                ('dash_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='django_dashboard.Company')),
