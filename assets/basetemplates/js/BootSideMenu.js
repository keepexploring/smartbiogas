...
(function ($) {
    ...
    $.fn.BootSideMenu = function (userOptions) {
        ...
        $("[data-toggle=\"collapse\"]", menu).each(function () {
            var icona = $("<span class=\"fa fa-angle-down\"></span>");
            $(this).prepend(icona);
        });
        ...
        menu.on("click", ".list-group-item", function () {
            ...
            $(".fa", this).toggleClass("fa-angle-up").toggleClass("fa-angle-down");
        });
        ...
        function switchArrow(side) {
            ...
            if (side == "left") {
                span.removeClass("fa-angle-double-left").addClass("fa-angle-double-right");
            } else if (side == "right") {
                span.removeClass("fa-angle-double-right").addClass("fa-angle-double-left");
            }
        }
